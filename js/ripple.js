function createRipple(event, element) {
  let panelContainer = element.closest(
    ".experience-block, .education-card, .tools, .contact-section, .interests",
  );
  ...
  if (!panelContainer) {
    if (element.closest(".languages")) {
      ...
      panelContainer =
        ...
        element.closest(".interests") ||
        element.closest(".extra");
    }
  }
  ...
  if (
    panelContainer.classList.contains("experience-block") &&
    panelContainer === panelContainer.parentElement.firstElementChild
  ) {
    ripple.classList.add("ripple-dark");
  }
  if (
    panelContainer.closest(".contact-section") ||
    panelContainer.classList.contains("contact-section")
  ) {
    ripple.classList.add("ripple-dark");
  }
